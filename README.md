...
4. **Networking**: Public traffic đi từ Cloudflare tới **AWS Application Load Balancer (ALB)**, sau đó được route vào Kubernetes thông qua ALB Ingress Controller.
...
### Các Layers
- **`00-networking`**: VPC, Subnets, NAT Gateways, ALB, và Target Groups.
...
- **Ingress**: Định nghĩa Ingress rule trỏ về AWS ALB.
...
1. `cd infra/aws/terraform/layers/00-networking`
   - `terraform init`
   - `terraform apply -var-file="../../environments/dev/terraform.tfvars"`
2. Lặp lại bước trên cho `01-kubernetes`, `02-data`, `03-storage`, `04-observability`.
